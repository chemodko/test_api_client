...
@allure.feature("Updating list of DLCs")
class TestUpdateDLCList:
    @allure.title("Update list of DLCs")
    ...
    @allure.title("Update list of DLCs of the game that not exist")
    ...
    @allure.title("Update list DLCs with wrong DLC field")
    ...
    @allure.title("Update list of DLCs without authorization")
